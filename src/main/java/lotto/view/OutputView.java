...
public class OutputView {
    ...
    private final static String PURCHASE_RESULT_MESSAGE = "%d개를 구매했습니다.";
    private final static String RESULT_MESSAGE = "당첨 통계\n---";
    private final static String RESULT_MATCH_COUNT_MESSAGE = "%d개 일치";
    private final static String RESULT_BONUS_MATCH_MESSAGE = ", 보너스 볼 일치";
    private final static String RESULT_AMOUNT_MESSAGE = " (%,d원) - %d개\n";
